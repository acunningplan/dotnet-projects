...
namespace FunFacts.Infrastructure
{
    public class PhotoService
    {
        ...
        //private FunFact _funFact;

        public PhotoService(FunFactsContext context, IUserAccessor userAccessor)
        {
            _context = context;
        ...
        //    blog.Images.Add(
        //        new FunFacts.Entities.Image() { Url = url, ImgurId = id, DeleteHash = deleteHash });
        ...
        //public async Task<FunFacts.Entities.Image> GetPhotoByUrl(string url)
        //{
