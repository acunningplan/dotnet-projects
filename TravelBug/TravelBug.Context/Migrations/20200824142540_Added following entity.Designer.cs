...
namespace TravelBug.Context.Migrations
{
    ...
    [Migration("20200824142540_Added following entity")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TravelBug.Entities.User.UserFollowing", b =>
                {
            ...
            modelBuilder.Entity("TravelBug.Entities.User.UserFollowing", b =>
                {
                    b.HasOne("TravelBug.Entities.User.AppUser", "Observer")
                        .WithMany("Followings")
                        .HasForeignKey("ObserverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TravelBug.Entities.User.AppUser", "Target")
                        .WithMany("Followers")
